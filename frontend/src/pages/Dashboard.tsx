    ...
    return (
        <div className="dashboard fade-in">
            ...
            <div className="stats-grid">
                ...
                <StatCard icon={<Coins size={24} />} label={t('dashboard.miningReward')} value={`${stats?.miningReward || 0} ${stats?.coinSymbol || 'EDU'}`} />
                <StatCard icon={<Timer size={24} />} label={t('dashboard.nextHalving')} value={`${stats?.blocksUntilHalving || 0} ${t('common.blocks')}`} />
                <StatCard icon={<BarChart3 size={24} />} label={t('dashboard.totalSupply')} value={`${(stats?.totalSupply || 0).toLocaleString()} EDU`} />
                <StatCard icon={<Scissors size={24} />} label={t('dashboard.halvingsDone')} value={stats?.halvingsDone || 0} />
            </div>
